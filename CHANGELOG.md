...
* capture all W3C fields in ResourceEvents (#489)
* capture all W3C fields in NavigationEvents (#494)
...
* add config options for reportAll CLS and LCP ([f1ebe53](https://github.com/aws-observability/aws-rum-web/commit/f1ebe534e29f6832f10252e496af42c03bf72535))
* add metadata field "aws:releaseId" ([#648](https://github.com/aws-observability/aws-rum-web/issues/648)) ([c8bc3be](https://github.com/aws-observability/aws-rum-web/commit/c8bc3bed54e0e6b6b6eb82d5c05ee93978ac6d7b))
...
* capture all W3C fields in NavigationEvents ([#494](https://github.com/aws-observability/aws-rum-web/issues/494)) ([0ae8db5](https://github.com/aws-observability/aws-rum-web/commit/0ae8db544c0639221a594a7755fa251f40065d8a))
* capture all W3C fields in ResourceEvents ([#489](https://github.com/aws-observability/aws-rum-web/issues/489)) ([15c0076](https://github.com/aws-observability/aws-rum-web/commit/15c007609bf81abb8ba6b02889e5a8f0bc7c718c))
...
* Support use of an alias field ([#600](https://github.com/aws-observability/aws-rum-web/issues/600)) ([ff5fda4](https://github.com/aws-observability/aws-rum-web/commit/ff5fda453e43503400b5cf2e4c580c3e8588d220))
...
* upgrade web-vitals to 4.x ([8ee8e56](https://github.com/aws-observability/aws-rum-web/commit/8ee8e565f5614f94a32a419577be6d66eb326925))
...
* add prerender offset to tti events ([#662](https://github.com/aws-observability/aws-rum-web/issues/662)) ([a6d2a3f](https://github.com/aws-observability/aws-rum-web/commit/a6d2a3f09c351286cb52ad6c1367a87b6d3abdf2))
...
* output inline source maps with tsc ([f674f4f](https://github.com/aws-observability/aws-rum-web/commit/f674f4f807139aee086ecc27415a04eefa199e82))
...
* update @aws-crypto/sha256-js dependency to version 3.0.0 ([#596](https://github.com/aws-observability/aws-rum-web/issues/596)) ([fadc526](https://github.com/aws-observability/aws-rum-web/commit/fadc52694bf4abc4f07963d438279e9ff05c2ddd))
...
* Upgrade playwright to latest version to fix release workflow ([#607](https://github.com/aws-observability/aws-rum-web/issues/607)) ([3dd5b9d](https://github.com/aws-observability/aws-rum-web/commit/3dd5b9d6cafac7d8109d83f94f6d44974ea0f4d3))
...
* Use port from endpoint url to create HttpRequestOptions ([b2d08c3](https://github.com/aws-observability/aws-rum-web/commit/b2d08c31b25494ee139683736befbd90d024b187))
